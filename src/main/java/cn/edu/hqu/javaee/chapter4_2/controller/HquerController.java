package cn.edu.hqu.javaee.chapter4_2.controller;
...
import cn.edu.hqu.javaee.chapter4_2.Chapter42Application;
import cn.edu.hqu.javaee.chapter4_2.controller.formEntity.LoginForm;
import cn.edu.hqu.javaee.chapter4_2.controller.formEntity.RegisterForm;
		...
		if (errors.hasErrors())
			...
			if (!hquerService.register(hquer)) {
				...
				Files.copy(registerForm.getPicFile().getInputStream(),
						Paths.get(Chapter42Application.ROOT, hquer.getUserName() + ".jpeg"),
